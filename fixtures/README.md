...
| `14-dispatch-collect` | Does the orchestrator block on `TaskOutput` to collect a dispatch, instead of ending its turn and being re-entered with a fresh turn allowance — and does it still dispatch independent tasks concurrently? | **specified 2026-09-09, not yet run** |
